...
3. The "knitr" package, promarily to allow nice display of tables (the ```kable``` function).
...
In order to decide on a proper threshold for the TRUE/FALSE definotion, let's observe the distribution of percentages:
```{r}
df_users %>%
